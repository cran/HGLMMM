#######################################
##### Inference on Overdispersion #####
#######################################
ProfileODispNormal<-function(DYgamma=NULL,Y=NULL,X=NULL,ZZ=NULL,SS=NULL,Beta=NULL,Vstart=NULL,OFFSET=NULL,Link=c("Identity"),
    ...
    #for (iii in 1:3){
        ...
        dhhatdphi<-(-0.5*(1/Phi))+(0.5*((Y-mu)^2)/(Phi^2))
