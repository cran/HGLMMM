...
#########################################################
HlikePoi<-function(Y=NULL,X=NULL,ZZ=NULL,SS=NULL,Beta=NULL,Vstart=NULL,OFFSET=NULL,Link=c("Log"),EstimateOverDisp=FALSE,LaplaceFixed=FALSE,
    ...
    HLikelihood<-0
    HLikelihood<-sum((Y)*log(mu)-(mu))-sum(lfactorial(Y))
