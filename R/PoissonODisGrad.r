...
ProfileODispPoisson<-function(DYgamma=NULL,Y=NULL,X=NULL,ZZ=NULL,SS=NULL,Beta=NULL,Vstart=NULL,OFFSET=NULL,Link=c("Log"),
    ...
    #for (iii in 1:3){
        ...
        #print("DDY");print(DDY);
        if (DEBUG) {print("Phi");print(Phi);print("Wvec");print(Wvec)}
        ...
        if (DEBUG) {print("DiagDeriv");print(DiagDeriv)}
        ...
        #print("Beta");print(Beta);print("VT");print(VT)
        Derivative
